                    ...
                    <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
                        <Grid container spacing={2}>
                            ...
                            <TextField
                                ...
                                name="password"
                                label="Password"
                                type={formData.showPassword ? 'text' : 'password'} // Use showPassword state
                                id="password"
                                ...
                                InputProps={{
                                    endAdornment: (
                                        <IconButton
                                            ...
                                            onClick={handleShowPassword} // Use the correct handler
                                            edge="end"
                                        >
                            ...
                            <TextField
                                ...
                                type={formData.showConfirmPassword ? 'text' : 'password'} // Use showConfirmPassword state
                                id="confirmPassword"
                                autoComplete="new-password"
                                ...
                                InputProps={{
                                    endAdornment: (
                                        <IconButton
                                            ...
                                            onClick={handleShowConfirmPassword} // Use the correct handler
                                            edge="end"
                                        >
